import 'package:a2v1/sports/firebasehelper.dart';
...
class _SportsScreenFirebaseState extends State<SportsScreenFirebase> {
  ...
  void initState() {
    ...
    FirestoreHelper.getInstance().then((obj) {
      _firestoreHelper = obj;
      _firestoreHelper.getAllGamesData().then((value) {
        listAllGames = value;
